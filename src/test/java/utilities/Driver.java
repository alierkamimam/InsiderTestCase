...
public class Driver {
	...
	/**
	 * Returns a new instance of a WebDriver based on the browser specified in the
	 * configuration properties file. If an instance of the WebDriver already exists, that
	 * instance is returned.
	 * @return a new instance of a WebDriver
	 * @throws RuntimeException if an invalid browser is specified in the configuration
	 * properties file
	 */
			...
			switch (browserName) {
				...
				default:
					throw new RuntimeException(
							"Invalid browser name specified in configuration properties file: " + browserName);
			}
