...
public class End2End extends BaseTest {
	...
	/*
	 * 1. Visit https://useinsider.com/ and check Insider home page is opened or not 2.
	 * Select “More” menu in navigation bar, select “Careers” and check Career page, its
	 * Locations, Teams and Life at Insider blocks are opened or not 3. Click “See All
	 * Teams”, select Quality Assurance, click “See all QA jobs”, filter jobs by Location
	 ...
	 * “Quality Assurance”, Location contains “Istanbul, Turkey” and “Apply Now” button 5.
	...
	public void insiderWebPageTest() throws IOException {
		// Launch browser via @BeforeSuit in BaseTest and Navigate to urlHomePage
		...
		// Checks that all jobs’ Position contains “Quality Assurance”, Department
		// contains
		// “Quality Assurance”, Location contains “Istanbul, Turkey” and “Apply Now”
		// button
		...
		softAssert.assertEquals(Driver.getDriver().getCurrentUrl(),
				"https://jobs.lever.co/useinsider/0ba4065b-955a-4661-ad4a-f32479f63757");
		softAssert.assertEquals(Driver.getDriver().getTitle(),
				"Insider. - Software Quality Assurance Engineer (Remote)");
